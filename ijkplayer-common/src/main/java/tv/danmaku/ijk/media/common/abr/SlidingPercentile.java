...
public class SlidingPercentile {
  ...
  public void addSample(int weight, float value) {
    Log.d("SlidingPercentile", String.format("addSample weight=%d, speed=%.2fMbps", weight, (value / 1024 / 1024)));
    ensureSortedByIndex();
...
//    Log.d("SlidingPercentile", "getPercentile from samples " + Arrays.toString(samples.toArray()));
